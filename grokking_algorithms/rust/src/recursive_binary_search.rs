...
mod tests {
    ...
    fn test_recursive_binary_search_usize_found() {
        ...
        let result = recursive_binary_search(num_slice.clone(), 30, 0, num_slice.len() - 1);
    ...
    fn test_recursive_binary_search_usize_not_found() {
        ...
        let result = recursive_binary_search(num_slice.clone(), 200, 0, num_slice.len() - 1);
    ...
    fn test_recursive_binary_search_string_found() {
        ...
        let result = recursive_binary_search(num_slice.clone(), "c", 0, num_slice.len() - 1);
    ...
    fn test_recursive_binary_search_string_not_found() {
        let num_slice = vec!["a", "b", "c"];
        let result = recursive_binary_search(num_slice.clone(), "d", 0, num_slice.len() - 1);
